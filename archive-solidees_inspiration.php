 ...
 *
 * The template for displaying inspirations
 *
 * @package Solidees
 * @subpackage Templates
 * @since Solidees 0.1.0
 */

if (is_page()) {
	wp_redirect(get_post_type_archive_link('solidees_inspiration'), 301);
	die();
}
			...
			<?php if ( have_posts() ) : ?>
					...
					<h1 class="page-title">
						<?php
							...
							elseif ( is_tax( 'post_format', 'post-format-chat' ) ) :
								...
								_e( 'Idées et projets inspirants', 'solidees' );
				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<?php
						 ...
						 */
						get_template_part( 'content', 'inspiration' );
					?>

				<?php endwhile; ?>

				<?php solidees_inspiration_paging_nav(); ?>
