...
<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
	<header class="entry-header page-header">
		...
		<a class="btn btn-default read-more" href="<?php the_permalink(); ?>"><?php _e( 'Lire la fiche', 'solidees' ); ?> <i class="fa fa-chevron-right"></i></a>
	...
	<div class="entry-content">
		...
		<a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" >
		 	<?php the_post_thumbnail( 'dazzling-featured', array( 'class' => 'thumbnail col-sm-2 col-md-offset-1' )); ?>
		</a>
		<div class="col-sm-9">
			<?php the_excerpt(); ?>
		</div>
